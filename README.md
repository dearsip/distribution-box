...
![Screenshot](images/4dmaze.jpg)

[FourMaze.unitypackage](https://github.com/dearsip/distribution-box/raw/main/FourMaze.unitypackage)

[4D Viewer Web](https://github.com/dearsip/FourDViewerWeb)と同様のVR操作で迷路を探索するワールド用ギミックです。  
[こちらのワールド](https://vrchat.com/home/launch?worldId=wrld_aaf41432-a2a9-489e-afa5-5b8af4d8a415)に設置しているギミックからスコアの保存やランキングの機能を除いたものです。

## Diffraction Simulator

![Screenshot](images/diffraction.png)

[DiffractionSimulator.unitypackage](https://github.com/dearsip/distribution-box/raw/main/DiffractionSimulator.unitypackage)

X線回折装置により結晶で生じるX線回折の様子を描画するワールド用ギミックです。  
`SampleScene.unity`は[こちらのワールド](https://vrchat.com/home/launch?worldId=wrld_756f4832-2f16-4460-b878-6f04cc2386f6)から外部のアセットを除いたもので、`DiffractionSiimulator.prefab`はそこからギミック本体のみを保存したものです。
